...
const PageBleue = ({ onBack, onNext }) => {
  return (
    <div className="h-screen w-screen bg-blue-500 text-white flex flex-col p-10">
      <button 
        onClick={onBack}
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-6">
        <h1 className="text-6xl font-bold mb-6">Page Bleue</h1>
        <p className="text-2xl text-blue-100 max-w-2xl text-center mb-8">
          Voici la liste de vos projets en cours...
        </p>
