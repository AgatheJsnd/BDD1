...
const PieceGreen = ({ position, rotation = 0, isDragging = false, onMouseDown }) => {
  return (
    <div 
    ...
    >
      <div 
        className={`w-40 h-40 shadow-2xl rounded-xl transition-all duration-200 bg-green-500 ${
