  ...
  return (
    <div className="h-screen w-screen bg-red-500 text-white flex flex-col p-10 animate-in slide-in-from-right duration-300">
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-6">
        <h1 className="text-6xl font-bold mb-6">Bienvenue sur la Page Rouge</h1>
        <p className="text-2xl text-red-100 max-w-2xl text-center mb-8">
          Attention : 3 notifications importantes ! Cette page vous alerte sur les événements critiques nécessitant votre attention.
        </p>
        
        {/* Bouton Suivant (ferme tout ou boucle) */}
        <button 
          onClick={onNext}
