...
const PageVerte = ({ onBack, onNext }) => {
  return (
    <div className="h-screen w-screen bg-green-500 text-white flex flex-col p-10 animate-in slide-in-from-right duration-300">
      <button 
        onClick={onBack}
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-6">
        <h1 className="text-6xl font-bold mb-6">Bienvenue sur la Page Verte</h1>
        <p className="text-2xl text-green-100 max-w-2xl text-center mb-8">
          Tous les systèmes sont opérationnels. Cette page dédiée au statut vert vous permet de suivre l'état de vos services.
        </p>
